...
namespace Dashboard.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(TestAppContext context)
        {
            _context = context;
        }
        ...
        {
            var testAppContext = _context.Orders.Include(o => o.User);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId")] Order order)
        {
